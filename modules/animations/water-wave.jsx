...
const WaterAnimation = () => {
    ...
    let vectorValue : Vector2 = uniform.resolution.value;
    vectorValue.x = window.innerWidth;
    vectorValue.y = window.innerHeight;
    ...
    return (
        <>
            <mesh ref={meshRef}>
                <planeBufferGeometry args={[window.innerWidth, window.innerHeight, 40]} />
                <shaderMaterial uniforms={uniform} />
            </mesh>
        </>
    )
}
